...
class T5Model(MegatronModule):
    """T5 Language model with dynamic parallelism support."""
    ...
    def __init__(self,
        ...
        # T5 has both encoder and decoder
    ...
    def update_parallel_state(self, tp_size=None, pp_size=None):
        ...
        if tp_size and tp_size != self.current_tp_size:
            ...
            # Update language model (encoder-decoder)
            self.language_model.update_parallel_state(tp_size=tp_size)

        if pp_size and pp_size != self.current_pp_size:
            self.current_pp_size = pp_size
            self.language_model.update_parallel_state(pp_size=pp_size)
