...
class MixedFusedLayerNorm(torch.nn.Module):
    """Mixed precision layer normalization with dynamic parallel support."""
    ...
    def __init__(self, normalized_shape, eps=1e-5):
        ...
        # Initialize parallel attributes
        self._set_parallel_attributes()
    ...
    def _set_parallel_attributes(self):
        """Set tensor parallel attributes for the layer."""
        if hasattr(self.weight, 'model_parallel'):
            return
        
        for param in [self.weight, self.bias]:
            mpu.set_tensor_model_parallel_attributes(param, True, 0, self.current_tp_size)
